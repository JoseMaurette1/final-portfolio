        ...
        {education.map((edu) => (
          ...
          >
            ...
            <div className="relative h-full w-full rounded-[15px] bg-white p-4 dark:bg-zinc-950">
              <div className="relative flex w-full flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                <div className="min-w-0 flex-1">
                  <h4 className="text-sm leading-tight font-normal sm:text-base dark:text-zinc-100">
                    {edu.degree}
                  </h4>
                  <p className="mt-1 text-sm leading-tight text-zinc-500 dark:text-zinc-400">
                    {getInstitutionDisplay(edu.institution)}
                  </p>
                </div>
                <p className="text-sm whitespace-nowrap text-zinc-600 dark:text-zinc-400">
